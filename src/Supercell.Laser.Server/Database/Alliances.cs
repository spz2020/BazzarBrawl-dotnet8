namespace Supercell.Laser.Server.Database
{
    ...
    public static class Alliances
    {
        ...
        public static int GetAllianceCount()
        {
            int rowCount = 0;
            ...
            try
            {
                using (var connection = new MySqlConnection(ConnectionString))
                {
                    ...
                    using (var cmd = new MySqlCommand("SELECT COUNT(*) FROM alliances", connection))
                    {
            ...
            {
                Console.WriteLine($"Error in alliances: {ex.Message}");
            }

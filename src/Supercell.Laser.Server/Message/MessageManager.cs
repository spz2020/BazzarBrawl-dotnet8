namespace Supercell.Laser.Server.Message
{
    ...
    public class MessageManager
    {
        ...
        public CommandManager CommandManagerr;
        ...
        public void ReceiveMessage(GameMessage message)
        {
            ...
            switch (message.GetMessageType())
            {
                ...
                case 10555:
                    break;
                case 24115:
                    //ServerErrorMessage((ServerErrorMessaage)message); 
                    break;
                case 14101:
                ...
                case 14106:
                    ...
                    break;
                case 14177:
                    PlayAgainStatusReceived((PlayAgainStatusMessage)message); break;
                case 14107:
                ...
                case 14113:
                    ...
                    break;
                case 14277:
                    GetSeasonRewardsMessage((GetSeasonRewardsMessage)message);
                    break;
                case 14166:
                    break;
                case 14301:
                ...
                case 14600:
                    ...
                    break;
                case 14114:
                    GetBattleLogMessage((GetBattleLogMessage)message);
                    break;
        ...
        private LogicBattleModeServer SpectatedBattle;
        ...
        private void ReportAllianceStreamReceived(ReportAllianceStreamMessage message)
        {
            ...
            foreach (AllianceStreamEntry e in myAlliance.Stream.GetEntries())
            {
                ...
                if (e.Id == message.MessageIndex)
                {
                    ...
                    try { text += myAlliance.Stream.GetEntries()[index + 4].SendTime + " " + LogicLongCodeGenerator.ToCode(myAlliance.Stream.GetEntries()[index + 4].AuthorId) + " " + myAlliance.Stream.GetEntries()[index + 4].AuthorName + ">>> " + myAlliance.Stream.GetEntries()[index + 4].Message + "\n"; } catch { }
                    try { text += myAlliance.Stream.GetEntries()[index + 5].SendTime + " " + LogicLongCodeGenerator.ToCode(myAlliance.Stream.GetEntries()[index + 5].AuthorId) + " " + myAlliance.Stream.GetEntries()[index + 5].AuthorName + ">>> " + myAlliance.Stream.GetEntries()[index + 5].Message + "\n"; } catch { }
                    Logger.Print($"Player {reporterName}, {reporterTag} reported player {susName}, {susTag}, in this msgs:\n`\n{text}`");
                    Connection.Send(new ReportUserStatusMessage()
                    {
                        Status = 1
                    });
        ...
        private void StartSpectateReceived(StartSpectateMessage message)
        {
            ...
            LogicBattleModeServer battle = Battles.Get(battleId);
        ...
        private void AskForBattleEndReceived(AskForBattleEndMessage message)
        {
            ...
            if (message.players == 6)
            {
                if (battleEnd3vs3.BrawlerTrophies >= 0 && battleEnd3vs3.BrawlerTrophies <= 49)
                {
                    ...
                    {
                        battleEnd3vs3.TrophiesReward = 800;
        ...
        //private void ServerErrorMessaage(ServerErrorMessaage message)
        //{
        //    ;
        //}
        ...
        {
            if (message.LeaderboardType == 1 || message.LeaderboardType == 3)
            {
        ...
        private void GetSeasonRewardsMessage(GetSeasonRewardsMessage message)
        {
            //if (message.Type == 1)
            //{
            SeasonRewardsMessage seasonRewards = new SeasonRewardsMessage();
            //seasonRewards.Type = 1;
            Connection.Send(seasonRewards);
            //}
        }

        private void GetBattleLogMessage(GetBattleLogMessage message)
        {
            BattleLogMessage battlelog = new BattleLogMessage();
            Connection.Send(battlelog);
        }
        ...
        private void PlayAgainStatusReceived(PlayAgainStatusMessage message)
        {
            PlayAgainMessage playAgain = new PlayAgainMessage();
        ...
        private void LoginReceived(AuthenticationMessage message)
        {
            ...
            loginOk.ServerEnvironment = "stage";

            Connection.Send(loginOk);

            CommandManagerr = new(HomeMode, Connection);
            ...
            LogicBattleModeServer battle = null;
        ...
        private void ClientHelloReceived(ClientHelloMessage message)
        {
            ...
            if (message.KeyVersion != 2139062143)
            {
                Connection.Send(new AuthenticationFailedMessage()
                {
                    ErrorCode = 8,
            ...
            System.Console.WriteLine(message.ClientSeed);
            if (message.Protocol != 3 && message.KeyVersion != 2139062143 && message.MajorVersion != 27 && message.ClientSeed == 0)
            {
                OwnHomeDataMessage ohd = new OwnHomeDataMessage();
                ohd.Avatar.Banned = true;
                Connection.Send(new AuthenticationFailedMessage()

namespace Supercell.Laser.Server.Logic.Game
{
    ...
    public class MatchmakingSlot
    {
        ...
        public const int MAX_BATTLES = 0;
        public const int SEARCH_TIMEOUT = 0;
        public const int MAX_BATTLES_TIMEOUT = 20;
        ...
        public static bool IsBlockedMatchmakingByFullyBattles()
        {

            if (Battles.m_battleIdCounter >= 0) return true;
            return false;
        }
        ...
        public void StartGame(List<MatchmakingEntry> entries)
        {
            ...
            LogicBattleModeServer battle = new LogicBattleModeServer(EventData.LocationId);
            ConsoleLogger.WriteTextWithPrefix(ConsoleLogger.Prefixes.Battle,
            "New Battle Spawned! GL");
